...
class MemorySummarizeToolTest < ActiveSupport::TestCase
  ...
  test "summarizes a person" do
    ...
    result = tool.execute(target: "person", name: "Aria", owner_id: @owner_id)
  ...
  test "summarizes a location" do
    ...
    @store.save!
    tool = MemorySummarizeTool.new()
    result = tool.execute(target: "location", name: "forest", owner_id: @owner_id)
  ...
  test "summarizes quest log" do
    tool = MemorySummarizeTool.new()
    result = tool.execute(target: "quest_log", owner_id: @owner_id)
